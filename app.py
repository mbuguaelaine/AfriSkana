...
from flask_cors import CORS # 🌟 ADDED: For enabling cross-origin requests
...
# --- 1. Initialization ---
app = Flask(__name__)
# 🌟 ADDED: Enable CORS for all routes, allowing the frontend to connect
CORS(app) 
...
# 🌟 CORRECTED: Changed route from '/scan' to '/api/scan' to match JavaScript fetch call
...
def scan_network():
    ...
    try:
        ...
        # 🌟 CORRECTED: The frontend sends 'target_ip' and 'scan_mode'
        target_ip = data.get('target_ip')
        mode = data.get('scan_mode', 'standard') # Expecting 'scan_mode', default to 'standard'
...
# 🌟 ADDED: Standard Flask run block for local development
